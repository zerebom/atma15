...
from atma15.features.features import MemberRatio, TargetEncoding, ExplicitFeature, SeverScale,W2V
...
features = [W2V(), MemberRatio(), TargetEncoding("score", agg_dict, st_folds)]
...
#%%
plt.hist(raw_train.groupby('user_id').agg(pl.col('anime_id').count().alias('cnt'))['cnt'],bins=300)
